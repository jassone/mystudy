...
golang中是没有class的,但是有一个结构体struct,有点类似,他没有继承的概念,但是他有一个类似功能的结构嵌入结构体可以封装多个基本数据类型，也就是我们可以通过struct来定义自己的类型了。
...
### 6、构造函数
Go语言的结构体没有构造函数，我们可以自己实现(通常以new开头)。 
