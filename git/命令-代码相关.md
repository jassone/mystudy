...
```
git checkout -b feat/hs-llm  // 创建并切换到新分支
git push -u origin feat/hs-llm  // 然后再推送到远端
```
...
```
git clone https://yanqing-5mRhq@codeup.aliyun.com/donglan/lanyan/backend/lanyan-mooc-v4.git
donglan1!


git clone https://yanqing-5mRhq:donglan1!@codeup.aliyun.com/donglan/lanyan/backend/lanyan-go-conf.git

# 查看远程分支情况
git remote -v 
# 重置账号密码
git remote set-url origin https://bianshiwu:rW5t_gG7uS8-Ad2r@codeup.aliyun.com/tyedo/back-end/tyedo-stat.git 
```
